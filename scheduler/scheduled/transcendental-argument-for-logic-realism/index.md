...
- Each must be self-identical (Identity: A = A, B = B)
- They cannot be both identical and non-identical (Non-Contradiction: not both A = B and A =/= B)
- They are either identical or non-identical (Excluded Middle: A = B or A =/= B)
