...
<div class="hero-banner-wrapper">
  <div class="hero-banner">
    <img src="{{ site.baseurl }}/assets/images/ai-research-banner.jpg" alt="AI Research & Philosophy Framework" />
  </div>
</div>

<div class="topic-header">
  <h1>Theoretical Framework</h1>
  <p>Understanding AI Limitations Through Foundational Concepts</p>
</div>
...
<div class="paper-grid">
  <div class="paper-card">
    ...
    <p>The complete theoretical framework establishing structural epistemic limitations in Large Language Models. Introduces SEEE, AIDK, IDKE, and MAPT concepts.</p>
    <div class="meta">January 2026 | DOI: 10.5281/zenodo.18316059</div>
  ...
  <div class="paper-card">
    ...
    <p>Human-Curated, AI-Enabled: A tiered approach to AI deployment based on epistemic authority and verification requirements.</p>
  ...
  <div class="paper-card">
    ...
    <p>The full theoretical program investigating AI through the origination-derivation lens. Includes research agenda, methodology, and open questions.</p>
...
The AIDK framework shares foundational primitives with [Logic Realism Theory](https://jdlongmire.github.io/logic-realism-theory/):
...
- [Zenodo: AIDK Framework](https://zenodo.org/records/18316059) - Persistent DOI-minted archive
- [GitHub: AI-Research](https://github.com/jdlongmire/AI-Research) - Source code and development
