...
- [AIDK Framework]({{ site.baseurl }}/framework/aidk/) - Operational framework for AI limitations
- [HCAE Model]({{ site.baseurl }}/framework/hcae/) - Deployment implications
- [Logic Realism Theory](https://jdlongmire.github.io/logic-realism-theory/) - Foundational $L_3$ framework
